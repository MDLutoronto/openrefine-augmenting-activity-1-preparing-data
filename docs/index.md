...
[Create a new project from a JSON file of book information and learn about rows vs records](#A)

[Join multiple cells into one cell to reduce the number of rows](#B)

[Use some advanced GREL and regex to reverse the author names in our dataset](#C)
...
![Use space, then the pipe character |, then another space as the separator.]({{ '/assets/images/openrefineworkshop74b.png' | relative_url }})
...
Technique: [Cleaning data](/technique/cleaning-data) \| Tools: [OpenRefine](/tools/openrefine)**Date Created:** 2019\-04\-03**Updated:** 2023\-10\-23
